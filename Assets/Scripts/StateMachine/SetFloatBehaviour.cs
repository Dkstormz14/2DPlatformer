...
public class SetFloatBehaviour : StateMachineBehaviour
{
    ...
    // OnStateMachineEnter is called when the state machine starts to evaluate this state machine
    ...
    // OnStateMachineExit is called when exiting a state machine via the Exit node
